...
let changeNameContent = '<input class="js-style-name1" type="text" name="" id="" placeholder="اسم المستخدم الجديد" minlength="1" maxlength="25">';
let changeNameContent2 = '<a class="js-style-name2">حفظ</a>';
let boxContainer = '<div class="js-style-box-name"></div>';
let boxContainer2 = '<div class="js-style-box-name2"></div>';

let inputold = '<input class="input-old" type"text" placeholder="كلمةالسر السابقة" maxlength="25">';
let inputnew = '<input class="input-new" type="password" placeholder="كلمةالسرالجديدة" maxlength="25">';
let inputconfirm = '<input class="input-confirm" type="password" placeholder="تاكيد كلمة السر" maxlength="25">';
let changePasswordContent2 = '<a id="hello" class="js-style-name2">حفظ</a>';
